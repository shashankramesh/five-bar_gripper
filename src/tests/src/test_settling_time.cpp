...
inline int square(double time, double freq)
{
  double Tm = 1./freq;
  int n = time/Tm;
  double rel_time = time - n*Tm;
...
int main(int argc, char** argv)
{
  ...
  ofstream log("settling_time_5bar/settling_time_y_23_06_13_ikb4_vellim0p1_v2.csv");
