...
// time <= total_time
  while(true)
  {
    ...
    std::cout << "Feedback configuration: " << conf_feed << endl
      << "Command configuration: " << conf_feed << endl
      << "phi feed: " << phi_feed << endl
      << "psi feed: " << psi_feed << endl
      << std::endl;
